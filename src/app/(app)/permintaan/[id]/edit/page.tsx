...
export default function EditPermintaanPage() {
  ...
  useEffect(() => {
    fetch(`/api/permintaan/${id}`)
      ...
      .then((data) => {
        // Blokir edit jika status bukan PENDING
  ...
  return (
    <div className="p-6 max-w-3xl mx-auto">
      <div className="flex items-center gap-3 mb-6">
        <Link href={`/permintaan/${id}`} className="btn-secondary p-2"><ArrowLeft size={16} /></Link>
        <div>
          <h1 className="text-xl font-bold text-gray-900">Edit Permintaan</h1>
          <p className="text-sm text-gray-500">Perbarui detail permintaan konsumsi</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} noValidate>
        <div className="card p-6 space-y-5">
          ...
          <div>
            ...
            <input id="namaAcara" type="text" value={namaAcara}
          ...
          <div>
            ...
            <input id="ruangan" type="text" placeholder="Contoh: Aula Utama" value={ruangan}
